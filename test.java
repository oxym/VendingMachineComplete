...
import ca.ucalgary.seng300.a1.ButtonListener;
import ca.ucalgary.seng300.a1.CReceptacleListener;
import ca.ucalgary.seng300.a1.CSlotListener;
import ca.ucalgary.seng300.a1.PCRListener;
...
public class test {
	...
	public void setUp() throws Exception {
	     ...
	     * Accepted coin values: 1, 5, 10, 25, 100, 200
	     * Number of pop types/selection buttons: 6
	     * Coin Rack Capacity: 200
	     * Pop Can Rack Capacity: 10
	     * Coin Receptacle Capacity: 200
	     * Pop (Name, Cost): (popA, 100), (popB, 100), (popC, 100), (popD, 100), (popE, 150), (popF, 200)
	     */
		vm = new VendingMachine(new int[] {1,5,10,25,100,200}, 6, 200,10,200);
	...
	@Test
	//Basic test wherein the correct coins are added, enough money is added, and the button is pressed
	...
	//Tests behavior when the correct coins are added, but not enough of them are added to buy a pop
	@Test
	...
	//The coin receptacle should still have the money that a user entered if pop was not vended
	@Test
	...
	//Tests such that if a user adds too little money,and presses a button, the money stays in the receptacle
